         ...
         <div class="col-lg-9">
            ...
            <article class="entry">
                  ...
                  <div class="entry-body">
                     ...
                     <h2 class="entry-title">
                        <a href="{{route('posts.single',['slug'=>'wola'])}}">Post Format - Image Gallery</a>
                     </h2>
            ...
            <article class="entry">
                  <div class="entry-body">
                     ...
                     <h2 class="entry-title">
                        <a href="{{route('posts.single',['slug'=>'wola'])}}">Hello World!</a>
                     </h2>

                     <div class="entry-content">
                        <p>Euismod atras vulputate iltricies etri elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel, congue sed ligula.</p>

                        <a href="{{route('posts.single',['slug'=>'wola'])}}" class="read-more">Read More <i class="icon-angle-double-right"></i></a>
                     </div><!-- End .entry-content -->

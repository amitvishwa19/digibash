            ...
            <article class="entry single">
                  <div class="entry-media">
                     <div class="entry-slider owl-carousel owl-theme owl-theme-light">
                        <img src="{{asset('public/themes/shoppy/assets/images/blog/post-1.jpg')}}" alt="Post">
                        <img src="{{asset('public/themes/shoppy/assets/images/blog/post-2.jpg')}}" alt="Post">
                        <img src="{{asset('public/themes/shoppy/assets/images/blog/post-3.jpg')}}" alt="Post">
                  ...
                  <div class="entry-body">
                     ...
                     <div class="entry-author">
                        ...
                        <figure>
                              <a href="#">
                                 <img src="{{asset('public/themes/shoppy/assets/images/blog/author.jpg')}}" alt="author">
                              </a>
                        </figure>
            ...
            <div class="related-posts">
                  ...
                  <div class="owl-carousel owl-theme related-posts-carousel">
                     <article class="entry">
                        <div class="entry-media">
                              <a href="single.html">
                                 <img src="{{asset('public/themes/shoppy/assets/images/blog/related/post-1.jpg')}}" alt="Post">
                              </a>
                        </div><!-- End .entry-media -->
                     ...
                     <article class="entry">
                        <div class="entry-media">
                              <a href="single.html">
                                 <img src="{{asset('public/themes/shoppy/assets/images/blog/related/post-2.jpg')}}" alt="Post">
                              </a>
                        </div><!-- End .entry-media -->
                     ...
                     <article class="entry">
                        <div class="entry-media">
                              <a href="single.html">
                                 <img src="{{asset('public/themes/shoppy/assets/images/blog/related/post-3.jpg')}}" alt="Post">
                              </a>
                        </div><!-- End .entry-media -->
            ...
            <div class="sidebar-wrapper">
                  ...
                  <div class="widget">
                     ...
                     <ul class="simple-entry-list">
                        <li>
                              <div class="entry-media">
                                 <a href="{{route('posts.single',['slug'=>'wola'])}}">
                                    <img src="{{asset('public/themes/shoppy/assets/images/blog/widget/post-1.jpg')}}" alt="Post">
                                 </a>
                              </div><!-- End .entry-media -->
                              <div class="entry-info">
                                 <a href="{{route('posts.single',['slug'=>'wola'])}}">Post Format - Video</a>
                                 <div class="entry-meta">
                                    April 08, 2018
                                 </div><!-- End .entry-meta -->
                              </div><!-- End .entry-info -->
                        ...
                        <li>
                              <div class="entry-media">
                                 <a href="{{route('posts.single',['slug'=>'wola'])}}">
                                    <img src="{{asset('public/themes/shoppy/assets/images/blog/widget/post-2.jpg')}}" alt="Post">
                                 </a>
                              </div><!-- End .entry-media -->
                              <div class="entry-info">
                                 <a href="{{route('posts.single',['slug'=>'wola'])}}">Post Format - Image</a>
                                 <div class="entry-meta">
                                    March 23, 2016
                                 </div><!-- End .entry-meta -->
                              </div><!-- End .entry-info -->

                  ...
                  <tbody>
                           ...
                           <td class="product-col">
                              <figure class="product-image-container">
                                 <a href="product.html" class="product-image">
                                       <img src="{{asset('public/themes/shoppy/assets/images/products/product-4.jpg')}}" alt="product">
                                 </a>
                              </figure>
                     ...
                     <tr class="product-row">
                           <td class="product-col">
                              <figure class="product-image-container">
                                 <a href="product.html" class="product-image">
                                       <img src="{{asset('public/themes/shoppy/assets/images/products/product-3.jpg')}}" alt="product">
                                 </a>
                              </figure>
                              <h2 class="product-title">

...
<!-- //for-mobile-apps -->
<link href="{{asset('public/themes/BestStore/css/bootstrap.css')}}" rel="stylesheet" type="text/css" media="all" />
<link href="{{asset('public/themes/BestStore/css/style.css')}}" rel="stylesheet" type="text/css" media="all" />

<!-- js -->
<script src="{{asset('public/themes/BestStore/js/jquery.min.js')}}"></script>
<!-- //js -->
<!-- cart -->
<script src="{{asset('public/themes/BestStore/js/simpleCart.min.js')}}"></script>
<!-- cart -->
<!-- for bootstrap working -->
<script type="text/javascript" src="{{asset('public/themes/BestStore/js/bootstrap-3.1.1.min.js')}}"></script>
<!-- //for bootstrap working -->
<link href='//fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
<link href='//fonts.googleapis.com/css?family=Lato:400,100,100italic,300,300italic,400italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>
<!-- timer -->
<link rel="stylesheet" href="{{asset('public/themes/BestStore/css/jquery.countdown.css')}}" />
<!-- //timer -->
<!-- animation-effect -->
<link href="{{asset('public/themes/BestStore/css/animate.min.css')}}" rel="stylesheet"> 
<script src="{{asset('public/themes/BestStore/js/wow.min.js')}}"></script>
<script>
 new WOW().init();
</script>
<!-- //animation-effect -->
			...
			<div class="logo-nav">
				...
				<div class="logo-nav-right">
					<div class="search-box">
						...
						<!-- search-scripts -->
						<script src="{{asset('public\themes\BestStore\js\classie.js')}}"></script>
					...
					<div class="cart box_1">
						<a href="checkout.html">
							<h3> <div class="total">
								...
								<img src="{{asset('public\themes\BestStore\images\bag.png')}}" alt="" />
							</h3>
						</a>
			...
			<div class="banner-bottom-grids">
				<div class="banner-bottom-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<div class="grid">
						<figure class="effect-julia">
							<img src="{{asset('public\themes\BestStore\images\4.jpg')}}" alt=" " class="img-responsive" />
							<figcaption>
				...
				<div class="banner-bottom-grid-left1 animated wow slideInUp" data-wow-delay=".5s">
					<div class="banner-bottom-grid-left-grid left1-grid grid-left-grid1">
						<div class="banner-bottom-grid-left-grid1">
							<img src="{{asset('public\themes\BestStore\images\1.jpg')}}" alt=" " class="img-responsive" />
						</div>
					...
					<div class="banner-bottom-grid-left-grid left1-grid grid-left-grid1">
						<div class="banner-bottom-grid-left-grid1">
							<img src="{{asset('public\themes\BestStore\images\2.jpg')}}" alt=" " class="img-responsive" />
						</div>
				...
				<div class="banner-bottom-grid-right animated wow slideInRight" data-wow-delay=".5s">
					<div class="banner-bottom-grid-left-grid grid-left-grid1">
						<div class="banner-bottom-grid-left-grid1">
							<img src="{{asset('public\themes\BestStore\images\3.jpg')}}" alt=" " class="img-responsive" />
						</div>
			...
			<div class="new-collections-grids">
				<div class="col-md-3 new-collections-grid">
					<div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
						<div class="new-collections-grid1-image">
							<a href="single.html" class="product-image"><img src="{{asset('public\themes\BestStore\images\7.jpg')}}" alt=" " class="img-responsive" /></a>
							...
							<div class="new-collections-grid1-right">
								<div class="rating">
									<div class="rating-left">
										<img src="{{asset('public/themes/BestStore/images/2.png')}}" alt=" " class="img-responsive" />
									</div>
									<div class="rating-left">
										<img src="{{asset('public/themes/BestStore/images/2.png')}}" alt=" " class="img-responsive" />
									</div>
									...
									<div class="rating-left">
										<img src="{{asset('public/themes/BestStore/images/1.png')}}" alt=" " class="img-responsive" />
									</div>
									<div class="rating-left">
										<img src="{{asset('public/themes/BestStore/images/1.png')}}" alt=" " class="img-responsive" />
									</div>
					...
					<div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
						<div class="new-collections-grid1-image">
							<a href="single.html" class="product-image"><img src="{{asset('public/themes/BestStore/images/8.jpg')}}" alt=" " class="img-responsive" /></a>
							<div class="new-collections-grid1-image-pos">
								<a href="single.html">Quick View</a>
							</div>
							<div class="new-collections-grid1-right">
				...
				<div class="col-md-6 new-collections-grid">
					<div class="new-collections-grid1 new-collections-grid1-image-width animated wow slideInUp" data-wow-delay=".5s">
						<div class="new-collections-grid1-image">
							<a href="single.html" class="product-image"><img src="{{asset('public/themes/BestStore/images/5.jpg')}}" alt=" " class="img-responsive" /></a>
					...
					<div class="new-collections-grid-sub-grids">
						<div class="new-collections-grid1-sub">
							<div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
								<div class="new-collections-grid1-image">
									<a href="single.html" class="product-image"><img src="{{asset('public/themes/BestStore/images/6.jpg')}}" alt=" " class="img-responsive" /></a>
									<div class="new-collections-grid1-image-pos">
										<a href="single.html">Quick View</a>
									</div>
									<div class="new-collections-grid1-right">
						...
						<div class="new-collections-grid1-sub">
							<div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
								<div class="new-collections-grid1-image">
									<a href="single.html" class="product-image"><img src="{{asset('public/themes/BestStore/images/9.jpg')}}" alt=" " class="img-responsive" /></a>
									<div class="new-collections-grid1-image-pos">
										<a href="single.html">Quick View</a>
									</div>
									<div class="new-collections-grid1-right">
				...
				<div class="col-md-3 new-collections-grid">
					<div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
						<div class="new-collections-grid1-image">
							<a href="single.html" class="product-image"><img src="{{asset('public/themes/BestStore/images/10.jpg')}}" alt=" " class="img-responsive" /></a>
							<div class="new-collections-grid1-image-pos">
								<a href="single.html">Quick View</a>
							</div>
							<div class="new-collections-grid1-right">
					...
					<div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
						<div class="new-collections-grid1-image">
							<a href="single.html" class="product-image"><img src="{{asset('public/themes/BestStore/images/11.jpg')}}" alt=" " class="img-responsive" /></a>
							<div class="new-collections-grid1-image-pos">
								<a href="single.html">Quick View</a>
							</div>
							<div class="new-collections-grid1-right">
		...
		<div class="container">
			<div class="timer-grids">
				<div class="col-md-8 timer-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					...
					<div id="counter"> </div>
					<script src="{{asset('public/themes/BestStore/js/jquery.countdown.js')}}"></script>
					<script src="{{asset('public/themes/BestStore/js/script.js')}}"></script>
				</div>
				<div class="col-md-4 timer-grid-right animated wow slideInRight" data-wow-delay=".5s">
					<div class="timer-grid-right1">
						<img src="{{asset('public/themes/BestStore/images/17.jpg')}}" alt=" " class="img-responsive" />
			...
			<div class="footer-grids">
				...
				<div class="col-md-3 footer-grid animated wow slideInLeft" data-wow-delay=".7s">
					...
					<div class="footer-grid-left">
						<a href="single.html"><img src="{{asset('public/themes/BestStore/images/13.jpg')}}" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="{{asset('public/themes/BestStore/images/14.jpg')}}" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="{{asset('public/themes/BestStore/images/15.jpg')}}" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="{{asset('public/themes/BestStore/images/16.jpg')}}" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="{{asset('public/themes/BestStore/images/13.jpg')}}" alt=" " class="img-responsive" /></a>
					</div>

...
__webpack_require__(/*! ./theme */ "./resources/js/admin/theme.js");
...
$('.aside-body').find('a[href="' + CURRENT_URL + '"]').parent('li').addClass('active');
$('.aside-body').find('a[href="' + CURRENT_URL + '"]').parents('ul').closest('li').addClass('active show'); //App toadt
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\digibash\resources\js\admin\admin.js */"./resources/js/admin/admin.js");

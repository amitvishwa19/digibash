...
class SectionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('lms.pages.section.section');
    ...
    public function create()
    {
        ...
        //dd($teachers);
        return view('lms.pages.section.section_add',compact('courses','teachers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('lms.pages.section.section_edit',compact('section','courses','teachers'));
    }

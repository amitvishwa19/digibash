...
class StudentController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('lms.pages.student.student');
    ...
    public function create()
    {
        ...
        return view('lms.pages.student.student_add',compact('sections'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('lms.pages.student.student_edit',compact('student','sections'));
    }

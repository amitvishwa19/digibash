...
class ProductController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('digishop.admin.pages.product.product');
    }

    public function create()
    {
        $categories = Category::where('parent_id','<>', 0 )->orderby('created_at','desc')->get();
        return view('digishop.admin.pages.product.product_add',compact('categories'));
    }
    ...
    public function edit($id)
    {
        ...
        $product = Product::findOrFail($id);
        return view('digishop.admin.pages.product.product_edit',compact('product','categories','tags'));
    }

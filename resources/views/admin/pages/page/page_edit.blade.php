      ...
      <div class="mg-t-50">
        <form method="post" action="{{route('page.update', $page->id)}}">
          ...
          <div class="wpinput form-group">
              ...
              <input type="text" class="form-control"  name="page_title" value="{{$page->title}}{{old('page_title')}}">
          </div>
          ...
          <div class="form-group wpinput">
            ...
            <input type="text" name="body" style="display: none" id="bodyinput" value="{{$page->body}}{{ old('body') }}">
          </div>

          <div class="wpinput form-group">
              <label class="d-block"><b>Meta Description</b></label>
              <input type="text" class="form-control"  name="meta_description" value="{{$page->meta_description}}{{old('meta_description')}}">
          </div>

          <div class="wpinput form-group">
              <label class="d-block"><b>Meta Keyword</b></label>
              <input type="text" class="form-control"  name="meta_keywords" value="{{$page->meta_keywords}}{{old('meta_keywords')}}">
          </div>
          ...
          <div class="form-group wpinput">
            ...
            <div class="custom-control custom-switch">
              <input type="checkbox" class="custom-control-input" id="customSwitch1" name="page_status" @if($page->status == 'published') checked  @endif>
              <label class="custom-control-label" for="customSwitch1" id="pstatuslbl">@if($page->status == 'published') Publish @else Draft  @endif</label>
            </div>
          </div>

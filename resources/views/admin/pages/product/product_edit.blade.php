        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <div class="form-group">
                    ...
                    <select name="shop_id" class="form-control @error('shop_id') is-invalid @enderror">
                        ...
                        @foreach (auth()->user()->shops()->get() as $shop)
                            <option value="{{$shop->id}}" {{$product->shop_id == $shop->id ? 'selected' : null}}>{{$shop->name}}</option>
                        @endforeach
                    </select>
                    @error('shop_id')
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control @error('status') is-invalid @enderror">
                        ...
                        <option value="unavaliable" {{$product->status == 'unavaliable' ? 'selected' : null}}>Unavaliable</option>
                    </select>
                    @error('status')
                        <span class="invalid-feedback" role="alert">
                            <strong><i>{{ $message }}</i></strong>
            ...
            <div class="col-4">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price" step="any" class="form-control @error('price') is-invalid @enderror" value="{{$product->price}}{{old('price')}}">
                    @error('price')
                        <span class="invalid-feedback" role="alert">
                            <strong><i>{{ $message }}</i></strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="discount" class="form-control @error('discount') is-invalid @enderror" value="{{$product->discount}}{{old('discount')}}">
                    @error('discount')
                        <span class="invalid-feedback" role="alert">
                            <strong><i>{{ $message }}</i></strong>
                        </span>
                ...
                <div class="form-group">
                    <label class="d-block"><b>Product Discount (%)</b></label>
                    <input type="date" name="discount_start" class="form-control @error('discount') is-invalid @enderror" value="{{$product->discount_start}}{{old('discount_start')}}">
                    @error('discount')
                        <span class="invalid-feedback" role="alert">
                            <strong><i>{{ $message }}</i></strong>
                        </span>
                ...
                <div class="form-group">
                    <label class="d-block"><b>Product Discount (%)</b></label>
                    <input type="date" name="discount_end" class="form-control @error('discount') is-invalid @enderror" value="{{$product->discount_end}}{{old('discount_end')}}">
                    @error('discount')
                        <span class="invalid-feedback" role="alert">
                            <strong><i>{{ $message }}</i></strong>
                        </span>
            ...
            <div class="col-4">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="" cols="30" rows="3" class="form-control @error('description') is-invalid @enderror">{{$product->description}}{{old('description')}}</textarea>
                    @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong><i>{{ $message }}</i></strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <textarea name="excerpt" id="" cols="30" rows="2" class="form-control">{{$product->excerpt}}{{old('excerpt')}}</textarea>
                    @error('excerpt')
                ...
                <div class="form-group">
                    ...
                    <textarea name="meta_keyword" id="" cols="30" rows="2" class="form-control">{{$product->meta_keyword}}{{old('meta_keyword')}}</textarea>
                    @error('meta_keyword')
                        <span class="" role="alert">
                            <strong><i>{{ $message }}</i></strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <textarea name="meta_description" id="" cols="30" rows="2" class="form-control">{{$product->met_description}}{{old('meta_description')}}</textarea>

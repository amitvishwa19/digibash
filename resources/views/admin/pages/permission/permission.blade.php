  ...
  <div class="card">
    ...
    <div class="">
      ...
      <div class="d-flex mg-b-20">
        <h4>Permissions</h4>
        <a href="{{route('permission.create')}}" class="btn btn-success btn-xs mg-l-10">Add New Permission</a>
      </div>
        ...
        <div data-label="Example" class="mg-t-15">
            <table id="datatable" class="table table-color-primary">
              ...
              <tr style="padding-left:20px">
                  <th style="width:25%" class=""><b>Name</b></th>
                  <th style="width:45%" class=""><b>Description</b></th>
